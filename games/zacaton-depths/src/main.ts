...
import { DiveTouchControls } from "./touch/DiveTouchControls";
...
class GameApp {
  ...
  private readonly touchControls: DiveTouchControls;
  ...
  constructor() {
    ...
    this.touchControls = new DiveTouchControls(this.input);
